...
test('correct todolist should be removed', () => {
    const endState = todolistsReducer(startState, removeTodolistTC.fulfilled(todolistId1, 'requestID', todolistId1))
...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, addTodolistTC.fulfilled({todolist}, 'requestID', 'new todolist'))
...
test('todolists should be added', () => {
    ...
    const action = fetchTodolistsTC.fulfilled({todolists: startState}, 'requestAPI')
