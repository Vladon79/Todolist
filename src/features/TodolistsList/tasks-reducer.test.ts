...
test('correct task should be added to correct array', () => {
    ...
    const action = addTaskTC.fulfilled(task, 'reqestAPI', {title: task.title, todolistId: task.todoListId});
...
test('status of specified task should be changed', () => {
    ...
    const action = updateTaskTC.fulfilled(updateModal, 'requestAPI', updateModal);
...
test('new array should be added when new todolist is added', () => {
    const action = addTodolistTC.fulfilled({
            todolist: {
                id: "blabla",
                title: "new todolist", order: 0, addedDate: ''
            }
